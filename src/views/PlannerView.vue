                ...
                <div ref="timetableRef" class="glass-card shadow-glass p-6 rounded-bento overflow-x-auto backdrop-blur-2xl border-slate-200 z-20 relative text-slate-800">
                    ...
                    <div class="flex items-center gap-3 mb-5 pb-4 border-b border-slate-200">
                        <div class="flex items-center gap-2 min-w-0 flex-1">
                            <span class="text-slate-400 text-sm font-medium shrink-0">ตารางของ</span>
                            <input
                                type="text"
                                :value="studentName"
                                ...
                                maxlength="60"
                                class="font-kanit font-semibold text-lg text-slate-800 bg-transparent border-b-2 border-dashed border-slate-300 focus:border-pink-400 focus:outline-none placeholder-slate-300 min-w-0 flex-1 transition-colors px-1"
                            />
                        </div>
